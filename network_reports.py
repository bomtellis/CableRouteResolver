                ...
                rows.append(
                    {
                        **base,
                        ...
                        "link_aggregation_group_id": _text(connection.get("link_aggregation_group_id")),
                        "link_aggregation_mode": _text(connection.get("link_aggregation_mode")),
                        "link_aggregation_member_index": max(0, _int(connection.get("link_aggregation_member_index"))),
                        "link_aggregation_member_count": max(0, _int(connection.get("link_aggregation_member_count"))),
                        "aggregate_link_speed_mbps": max(0, _int(connection.get("aggregate_link_speed_mbps"))),
        ...
        rows.append(
            {
                ...
                "link_aggregation_member_count": max(0, _int(connection.get("link_aggregation_member_count"))),
                "aggregate_link_speed_mbps": max(0, _int(connection.get("aggregate_link_speed_mbps"))),
                "aggregate_expected_bandwidth_mbps": _float(connection.get("aggregate_expected_bandwidth_mbps")),
    ...
    schedules = [
        ...
        (
            ...
            [
                ...
                "link_aggregation_group_id", "link_aggregation_mode", "link_aggregation_member_index",
                "link_aggregation_member_count", "aggregate_link_speed_mbps",
        ...
        (
            ...
            [
                "connection_id", "connection_role", "medium", "link_speed_mbps",
                "link_aggregation_group_id", "link_aggregation_mode", "link_aggregation_member_index",
                "link_aggregation_member_count", "aggregate_link_speed_mbps", "aggregate_expected_bandwidth_mbps",
                "from_optic_module_id", "to_optic_module_id", "from_instance_id", "from_instance_name",
